...
public class SchemaInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        try {
            System.out.println("USTC LearnX: Adjusting schema for base64 profile picture uploads...");
            ...
            System.out.println("USTC LearnX: Successfully altered users.profile_pic_url to TEXT");
        } catch (Exception e) {
            // Log it - it might fail if column is already TEXT or table structure differs, which is fine
            System.out.println("USTC LearnX Schema adjustment status: " + e.getMessage());
        }
    }
}
